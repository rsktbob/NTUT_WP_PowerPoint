...
namespace Power_Point
{
    public partial class UploadForm : System.Windows.Forms.Form
    {
        ...
        {
            Google.Apis.Drive.v2.Data.File selecredFile = _fileListBox.SelectedItem as Google.Apis.Drive.v2.Data.File;
            _service.DownloadFile(selecredFile, _downloadPath);
        }
